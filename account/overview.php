								...
								<div class="card-body">
									<div class="d-flex align-items-center">
										<div>
											...
											<h4 class="my-1 text-white"><?= number_format(sqL('user')) ?></h4><br>
										</div>
								...
								<div class="card-body">
									<div class="d-flex align-items-center">
										<div>
											...
											<h4 class="my-1 text-white">$<?php $r = sqL('user')*50; echo number_format($r,2) ?></h4><br>
										</div>
								...
								<div class="card-body">
									<div class="d-flex align-items-center">
										<div>
											...
											<h4 class="my-1 text-white">$<?php $a = $pro->walletadmin($e); $v += $a; echo number_format($a,2) ?> <small class="text-success"><?php echo number_format(100*$a/$r,2) ?>%</small></h4>
										</div>
					...
					<div class="col">
							<div class="card radius-10 bg-warning bg-gradient">
								<div class="card-body">
									<div class="d-flex align-items-center">
										<div>
											<p class="mb-0 text-dark">Total Payout</p>
											<h4 class="text-dark my-1">$<?php
											echo number_format($v,2) ?>  <small class="text-success"><?php echo number_format(100*$v/$r,2) ?>%</small></h4>
										</div>
								...
								<div class="card-body">
									<div class="d-flex align-items-center">
										<div>
											...
											<h4 class="text-dark my-1">$<?php //$c = 0; for ($i=11; $i <= 28  ; $i++) { 
												//$c += $pro->walletadmin($i);
											//}   
											//echo number_format($c,2) ?>  <small class="text-success"><?php // echo number_format(100*$c/$r,2) ?>%</small></h4>
										</div>
										<div class="text-dark ms-auto font-35"><i class='bx bx-cart-alt'></i>
										</div>
									</div>
								...
								<div class="card-body">
									<div class="d-flex align-items-center">
										<div>
											...
											<h4 class="text-light my-1">$<?php $d = $r-$v; echo number_format($d,2) ?>  <small class="text-success"><?php echo number_format(100*$d/$r,2) ?>%</small></h4>
										</div>
										<div class="text-dark ms-auto font-35"><i class='bx bx-cart-alt'></i>
										</div>
									</div>
