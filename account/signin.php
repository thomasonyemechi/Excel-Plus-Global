								...
								<div class="p-4 rounded">
									...
									<div class="form-body">
										<form class="row g-3" method="post">
										 ...
										 <div class="col-md-6 text-end">	<a href="reset-auth.php">Forgot Password?</a>
											</div> 
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" class="btn btn-primary" name="LoginUsers"><i class="bx bxs-lock-open"></i>Sign in</button>
												</div>
											</div>
										</form>
									</div>
