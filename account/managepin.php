...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">PIN</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Registration PINs</li>
							</ol>
						</nav>
					</div>
				</div>					
...
<div class="card">
					<div class="card-body">
						<div class="card-title"><div class="ms-auto" style="float: right;">
										...
										<div class="btn-group">
							<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">BUY PIN</button>
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														ACCOUNT BALANCE: $<?= number_format($pro->wallet($uid),2) ?><br><br>
															...
															<select id="pin" name="pin" class="form-control" required>
																<option value="">Select Option...</option>
										<?php $i=1; $end = floor($pro->wallet($uid)/REGFEE);
