...
<!--sidebar wrapper -->
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<!--	 <li> <a href="javascript:;"><i class="bx bx-right-arrow-alt"></i>Manage Registration PINs</a> -->
						...
						<li> <a href="processincentive.php"><i class="bx bx-right-arrow-alt"></i>Process Incentives</a>
						</li>
		...
		<!-- -->		<li>
				...
				<li>
					<a href="fundwallet.php" class="">
						<div class="parent-icon"><i class='bx bx-gift'></i>
						</div>
						<div class="menu-title">Fund Wallet</div>
					</a>
				</li>
				<li>
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<img src="assets/images/icons/diamond.png" class="user-img" alt="r"> <?php } else{ ?>
							<img src="uploads/<?php echo userName($uid,'photo') ?>" class="user-img" alt=""> <?php } ?>
							<div class="user-infom ps-3 text-dark">
								<p class="user-name mb-0"><b><?= userName($uid) ?></b></p>
								<p class="designattion mb-0"><?= $pro->stageTitle($stage) ?></p>
							</div>
						</a>
