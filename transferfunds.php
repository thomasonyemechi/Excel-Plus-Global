					...
					<div class="card">
						<div class="card-body">
							<div class="card-title"><div class="ms-auto" style="float: right;">
								<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Transfer Funds</button>
							</div>
							<h5 class="mb-0">Transfer Ledger</h5>
						...
						<div class="table-responsive mt-3">
							<table id="example" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
									$i=1;
									$sql = $db->query("SELECT * FROM wallet WHERE id='$uid' AND (type=2 OR type=20) ORDER BY sn DESC LIMIT 200 "); 
