...
<div class="card">
					<div class="card-body">
						<div class="card-title">
							<h5 class="mb-0">Referral Ledger</h5>
                               ...
                               <div class="table-responsive mt-3">
								  <table id="example" class="table table-bordered table-striped">
                                    <thead>
                                            ...
                                            <tbody>
                                            <?php  $i=1;
                                            $sql = $db->query("SELECT * FROM user WHERE sponsor='$uidx' ORDER BY sn DESC LIMIT 500 "); 
                                            while($row = $sql->fetch_assoc()){ $e = $i++;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo date("d-M-Y",strtotime($row['created'])) ?></td> </tr>
                                            <?php } ?>
                                            </tbody>
